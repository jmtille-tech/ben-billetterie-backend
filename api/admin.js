// api/admin.js
// Endpoint interne (réservé à Jean-Marc) pour consulter et corriger les entretiens BEN Billetterie.
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (action === 'update') {
      ...
      const payload = {};
      if (typeof body.synthese_texte === 'string') {
        payload.synthese_texte = body.synthese_texte;
      }
      if (body.donnees_structurees !== undefined && body.donnees_structurees !== null) {
        payload.donnees_structurees = body.donnees_structurees;
      }
